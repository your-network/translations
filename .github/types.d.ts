...
declare namespace Koine {
  interface Translations {
    ...
    "editor/qa": {
      ...
      addQuestion: string;
      search: {
        questions: { placeholder: string; results: string | { "0": string } };
        answers: { placeholder: string; results: string | { "0": string } };
      };
      draft: {
    ...
    "bodies/User": {
      ...
      level: string;
      top: string;
      contributionsOn: string | { "0": string };
    ...
    "bodies/QnA": {
      ...
      info: {
        ...
        own_answer: string;
        answer: string;
        answers: string | { "0": string; "1": string };
        askedBy: string;
        anonymous: string;
      };
      ownStatus: {
        pending: {
          questions: string | { "1": string };
          question: string;
          answer: string;
        };
      };
